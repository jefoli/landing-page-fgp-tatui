...
export const Address = () => {
  return (
    <SectionContainer className="centralize" color="#f5cb11">
      ...
      <h5>
        A EAD FGP é responsável por levar aos alunos uma metodologia intuitiva e
        professores qualificados através de unidades espalhadas em todas as
        regiões do Brasil.
      </h5>
      <ul>
        <li>
        ...
        <li>
          <h4>Rua Onze de agosto, 1471, Centro, Tatuí - SP</h4>
        </li>
      </ul>
      <Styled.Wrapper>
        <iframe

    ...
    <Styled.DefaultContainer>
        ...
        <Styled.BoxContent>
          <Styled.BoxStyle>
            ...
            <p>
              ...
              profissionais alinhados com as exigências do cotidiano, promovendo
              o desenvolvimento contínuo e a transformação da sociedade.
            </p>
          </Styled.BoxStyle>
        </Styled.BoxContent>
      </Styled.MissionBox>
      ...
      <Styled.BoxContent>
        ...
        <Styled.BoxStyle>
          ...
          <p>
            Fomentar a inovação e a pesquisa em diversas áreas de conhecimento,
            incentivando a descoberta de novos conhecimentos e avanços.
          </p>
        </Styled.BoxStyle>
      </Styled.BoxContent>
    </Styled.DefaultContainer>
